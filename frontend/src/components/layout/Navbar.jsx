...
const Navbar = ({ user, onOpenLogin, onOpenRegister, onLogout }) => {
    ...
    return (
        <nav className='bg-subsonic-navfooter border-b border-subsonic-border px-6 py-4 flex flex-wrap items-center justify-between gap-4 font-inter'>
            <AppLink href="/">
                <img
                    src={logo}
                    alt="Logo"
            ...
            <div className="flex flex-wrap items-center justify-center gap-x-6 gap-y-2 text-subsonic-text font-bold lg:gap-x-10">
